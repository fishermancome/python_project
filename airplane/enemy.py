...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.image_hit = pygame.image.load("ui/shoot/enemy2_hit.png").convert_alpha()
        self.destory_images = []
        self.destory_images.extend([\
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.image_hit = pygame.image.load("ui/shoot/enemy3_hit.png").convert_alpha()
        self.destory_images = []
        self.destory_images.extend([\
